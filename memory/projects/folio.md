...
- Library/file deletion and the existing save-failure handling issue remain pending. Chapter access is implemented in 0.5.0. Inversion is softened since 0.3.0; user-document colour feedback may require further tuning.
