...
- 2026-09-07: User likes the Apple UI. Remaining work is ordered in `ARBEITSPLAN.md`; both scrollbar sizes should glow brighter in neutral white.
- 2026-09-07: User explicitly asked to preserve the Claude original and continue Apple-inspired UI work only in this copy. Active branch `codex/apple-ui`; preceding lens checkpoint `2838df9`. Material and UI decisions are documented in `DESIGN.md`. Only Folio Test may be updated; no merge or GitHub push yet.
